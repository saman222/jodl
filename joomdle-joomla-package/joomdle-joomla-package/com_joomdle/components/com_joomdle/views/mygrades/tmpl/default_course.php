...
<P align="right">
<a href="index.php?option=com_joomdle&view=coursegrades&course_id=<?php echo $this->course['remoteid']; ?>&format=pdf"><img src="<?php echo JURI::root(); ?>/media/media/images/mime-icon-16/pdf.png" alt="PDF"></a>
</P>
<?php endif; ?>
