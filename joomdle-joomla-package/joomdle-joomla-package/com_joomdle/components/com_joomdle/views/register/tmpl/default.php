...
<form action="<?php echo ( 'index.php?option=com_joomdle' ); ?>" method="post" id="josForm" name="josForm" class="form-validate">
...
<tr>
	...
	<?php $link =  JFactory::getApplication()->input->get('link'); ?>
