...
<tr>
        <td width="25%" height="20" class="simpletable<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
...
?>
                <?php
					...
					<tr>
						...
						<td width="10%" style="text-align:center;" class="simpletable<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
							<?php 
								if ($item['due'])
