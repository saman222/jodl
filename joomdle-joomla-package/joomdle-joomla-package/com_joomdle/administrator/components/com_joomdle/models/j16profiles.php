...
class PluginsModelJ16profiles extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form_path = $comp_params->get( 'j16_form_path' );

		if ($form_path)
			$form = JForm::getInstance('myform', $form_path);
		else
			$form = JForm::getInstance('myform', JPATH_SITE.'/plugins/user/profile/profiles/profile.xml');



//		print_r ($form);
//		echo JPATH_ADMINISTRATOR.'/plugins/user/profile/profiles/profile.xml';
//		exit ();
		// Get the form.
	//	JForm::addFormPath(JPATH_ADMINISTRATOR.'/components/com_plugins/models/forms');
//		JForm::addFormPath(JPATH_ADMINISTRATOR.'/plugins/user/profile/profiles');
